...
and double-click `lighting-studio.bat`. Java and dependencies are included. To run its smoke
check, open PowerShell in the extracted folder and use `.\lighting-studio.bat --smoke`.
