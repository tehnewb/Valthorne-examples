...
and double-click `physics.bat`. Java and dependencies are included. To run its smoke
check, open PowerShell in the extracted folder and use `.\physics.bat --smoke`.
