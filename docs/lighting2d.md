...
and double-click `lighting2d.bat`. Java and dependencies are included. To run its smoke
check, open PowerShell in the extracted folder and use `.\lighting2d.bat --smoke`.
